 ...
 *
 */
public class HabitStatLogic implements IVolleyListener {
     ...
     */
    public HabitStatLogic(IView r, IServerRequest serverRequest){
        this.r = r;
     ...
     */
    public void updateHabitStat(String type, JSONObject json){
        if(type.equals("GET")){
...
//        url = "http://coms-309-rp-07.cs.iastate.edu:8080/demo/api/stats/newStat";
//        serverRequest.sendToServer(url, json, "POST", true);
